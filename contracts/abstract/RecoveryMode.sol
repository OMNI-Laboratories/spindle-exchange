...
import {BasePoolUserData} from "../libraries/BasePoolUserData.sol";
 ...
 */
abstract contract RecoveryMode is AccessControlUpgradeable {
    using FixedPoint for uint256;
    using BasePoolUserData for bytes;

    bytes32 public constant TODO_ROLE = keccak256("TODO_ROLE");
     ...
     */
    function enableRecoveryMode() external onlyRole(TODO_ROLE) {
     ...
     */
    function disableRecoveryMode() external onlyRole(TODO_ROLE) {
     ...
     */
    function inRecoveryMode() public view virtual returns (bool);
